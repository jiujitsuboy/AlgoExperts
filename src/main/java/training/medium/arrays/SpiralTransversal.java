...
//		int[][] matrix = new int[][] { { }};
        ...
        Integer[][] matrix = new Integer[][]{{27, 12, 35, 26}, {25, 21, 94, 11}, {19, 96, 43, 56}, {55, 36, 10, 18}, {96, 83, 31, 94}, {93, 11, 90, 16}};
...
//		System.out.println(Arrays.toString(spiral));
    ...
    public static List<Integer> spiralTraverse(int[][] matrix) {
        ...
        int offSet = 0;
        int availIndex = 0;
        int spiralMaxLength = matrix.length * matrix[0].length;

        List<Integer> spiral = new ArrayList<>(spiralMaxLength);

        while (availIndex < spiralMaxLength) {

            while (availIndex < spiralMaxLength && vertical < (matrix[0].length - offSet)) {
                spiral.add(availIndex++, matrix[horizontal][vertical]);
                vertical++;
            }
            ...
            while (availIndex < spiralMaxLength && horizontal < (matrix.length - offSet)) {
                spiral.add(availIndex++, matrix[horizontal][vertical]);
                horizontal++;
            }
            ...
            while (availIndex < spiralMaxLength && vertical >= offSet) {
                spiral.add(availIndex++, matrix[horizontal][vertical]);
                vertical--;
            }
            ...
            while (availIndex < spiralMaxLength && horizontal > offSet) {
                spiral.add(availIndex++, matrix[horizontal][vertical]);
                horizontal--;
            }
